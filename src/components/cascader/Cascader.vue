<template>
  <cas :data="options" @on-change="handleChange" :loadData="loadOption" transfer>
    <v-combobox multiple :label="label" :chips="chips" :clearable="clearable" v-model="selected" :required="required"
      :rules="defaultRules" :single-line="single" :box="box" :outline="outline">
